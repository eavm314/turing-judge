  ...
  const handleChangeName = async () => {
    const stateName = await showPrompt({
      ...
      validator: (value) => {
        ...
        if (value !== data.name && automaton.stateToIndex.has(value)) return "State name must be unique";
        return "";
      }
    });
    ...
    <div className="relative flex items-center justify-center size-24">
      ...
      <div
        className={cn(
          ...
          selected && 'border-4 outline-4 -outline-offset-[14px] border-green-500 outline-green-500',
